...
$types = '';
if ($busqueda !== '') {
    $where[] = "(nombre LIKE ? OR apellido LIKE ? OR codigo_estudiante LIKE ? OR carnet_number LIKE ? OR dni LIKE ?)";
    $like = '%' . $busqueda . '%';
...
<div class="d-flex flex-wrap justify-content-between align-items-end gap-3 mb-3">
    <div>
        ...
        <p class="text-secondary mb-0">Busca por nombre, filtra por grado/carrera y sección, y selecciona varios carnets para imprimir.</p>
    </div>
...
<div class="filter-panel mb-3">
    <form method="GET" class="row g-3 align-items-end" id="studentFilters">
        <div class="col-lg-4 col-md-6">
            ...
            <input id="q" type="search" name="q" class="form-control" value="<?php echo htmlspecialchars($busqueda); ?>" placeholder="Nombre, código, DNI o carnet">
        </div>
        <div class="col-lg-4 col-md-6">
