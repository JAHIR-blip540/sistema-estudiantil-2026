...
<div class="row mt-4">
    ...
    <?php
    $sql = "SELECT COUNT(*) as total FROM usuarios WHERE rol != 'admin' AND rol != 'padre'";
    $result = mysqli_query($conn, $sql);
    $personal = mysqli_fetch_assoc($result)['total'];
    ?>
    <div class="col-md-3">
        <div class="card-dashboard">
            <i class="fas fa-user-shield fa-2x" style="color: #2979FF;"></i>
            <h3 class="stat-number"><?php echo $personal; ?></h3>
